...
component extends="coldbox.system.Plugin" singleton{
	...
	*/
	function renderAvatar(required email,numeric size=80){
		...
		// check settings
		if( NOT prc.bbSettings.bb_gravatar_display ){ return ""; }
		
		// render it out
		savecontent variable="avatar"{
			writeOutput('<img class="gravatar" align="middle" src="http://www.gravatar.com/avatar.php?gravatar_id=#lcase(Hash(emailTarget))#&s=#arguments.size#&r=#prc.bbSettings.bb_gravatar_rating#" alt="Cool Gravatar" />');
		}
