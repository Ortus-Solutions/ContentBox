...
# Database: blogbox
# Generation Time: 2011-08-10 22:20:24 +0000
# ************************************************************
...
VALUES
	(1,'Luis','Majano','lmajano@gmail.com','lmajano','EE60C08DE56FCDAC31D7A0D8F2C8ED1D550A3670DCF577F43F0A44AB7523ECE6',b'1','2011-08-10 14:11:05','2011-07-08 00:00:00'),
...
CREATE TABLE `bb_comment` (
  ...
  KEY `idx_publishedComment` (`isApproved`,`FK_entryID`),
...
VALUES
	(22,'WOW! I really need to use this in all my sites now!','Luis Majano','127.0.0.1','blogbox@ortussolutions.com','www.ortussolutions.com','2011-07-30 10:10:32',b'1',5),
	(23,'ColdBox has changed my life, I really recommend it.','Luis Majano','127.0.0.1','lmajano@gmail.com','www.luismajano.com','2011-07-30 10:11:22',b'0',5);
...
LOCK TABLES `bb_customhtml` WRITE;
/*!40000 ALTER TABLE `bb_customhtml` DISABLE KEYS */;

INSERT INTO `bb_customhtml` (`contentID`, `title`, `slug`, `description`, `content`, `createdDate`)
VALUES
	(1,'news','news','test','test\r\n','2011-08-06 15:47:43');

/*!40000 ALTER TABLE `bb_customhtml` ENABLE KEYS */;
UNLOCK TABLES;
