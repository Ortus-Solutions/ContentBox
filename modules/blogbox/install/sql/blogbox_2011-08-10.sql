...
# Database: blogbox
# Generation Time: 2011-08-11 00:52:11 +0000
# ************************************************************
...
VALUES
	(1,'Luis','Majano','lmajano@gmail.com','lmajano','EE60C08DE56FCDAC31D7A0D8F2C8ED1D550A3670DCF577F43F0A44AB7523ECE6',b'1','2011-08-10 17:05:23','2011-07-08 00:00:00'),
...
INSERT INTO `bb_page` (`pageID`, `hits`, `HTMLKeywords`, `publishedDate`, `createdDate`, `slug`, `passwordProtection`, `allowComments`, `content`, `HTMLDescription`, `layout`, `title`, `isPublished`, `FK_authorID`)
VALUES
	(2,7,'','2011-08-10 17:25:00','2011-08-10 17:25:28','about-us','',b'1','<p>\r\n	Welcome to your BlogBox installation. Enjoy it!</p>\r\n','','','About Us',b'1',1);
