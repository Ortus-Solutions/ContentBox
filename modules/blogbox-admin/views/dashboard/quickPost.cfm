...
<div id="quickPost">
	<div id="quickPostContent">
		<!--- Entry Form  --->
		#html.startForm(action=rc.xehEntrySave,name="quickPostForm",novalidate="novalidate")#
			<h2>Quick Post</h2>
			<!--- published Date --->
			...
			#html.startFieldset(legend='<img src="#prc.bbRoot#/includes/images/category_black.png" alt="category" width="16"/> Categories')#
				<cfloop from="1" to="#arrayLen(rc.categories)#" index="x">
					...
					#html.label(field="category_#x#",content="#rc.categories[x].getCategory()#",class="inline")#
				</cfloop>
			#html.endFieldSet()#
			<!--- Button Bar --->
