...
<div class="main_column" id="main_column">
	<div class="box">
		<!--- Body Header --->
		<div class="header">
			<img src="#prc.bbroot#/includes/images/database.png" alt="settings" />
			Import Databases Into BlogBox
		</div>
		<!--- Body --->
		<div class="body">	
		...
		<p>
			From this import tool you can connect to other blog datasources and import your data into BlogBox. 
			All importing messages are being logged, so please verify your application logs for information.
		</p>
		
		<!--- dsn Info --->
		<fieldset>
		<legend><img src="#prc.bbRoot#/includes/images/database_black.png" alt="modifiers"/> <strong>Datasource Options</strong></legend>
			<p>
