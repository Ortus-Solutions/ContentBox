...
<div class="sidebar">
		...
		<div class="body">
			...
			<p class="center">
				<a href="#event.buildLink(rc.xehAuthors)#">
					<button class="button"> <img src="#rc.bbroot#/includes/images/go-back.png" alt="help"/> Back To Authors</button>
				</a>
			</p>			
		</div>
	</div>	
	...
	<div class="small_box">
		<div class="header">
			<img src="#rc.bbroot#/includes/images/users_icon.png" alt="info" width="24" height="24" />Author Details
		</div>
		<div class="body">
			<!--- Info --->
			<div class="floatLeft">
	...
	<div class="box">
		...
		<div class="body">
			...
			#html.startForm(name="authorForm",action=rc.xehAuthorSave)#
				...
				<!--- Fields --->
				#html.textField(name="firstName",bind=rc.author,label="First Name:",required="required",size="50")#
				#html.textField(name="lastName",bind=rc.author,label="Last Name:",required="required",size="50")#
				#html.inputField(name="email",type="email",bind=rc.author,label="Email:",required="required",size="50")#
				#html.textField(name="username",bind=rc.author,label="Username:",required="required",size="50")#
				<cfif NOT rc.author.isLoaded()>
				#html.textField(name="password",bind=rc.author,label="Password:",required="required",size="50")#
				</cfif>
			...
			#html.startForm(name="authorPasswordForm",action=rc.xehAuthorChangePassword)#
				...
				#html.hiddenField(name="authorID",bind=rc.author)#
				<!--- Fields --->
				#html.textField(name="password",label="Password:",required="required",size="50")#
				#html.textField(name="password_confirm",label="Confirm Password:",required="required",size="50")#
