...
<table name="entries_pager" id="entries_pager" class="tablelisting" width="100%">
	...
	<tbody>
		...
		<tr data-entryID="#entry.getEntryID()#">
			...
			<td class="center">
				<!--- View Command --->
				<a href="#event.buildLink(prc.bbEntryPoint & "/#entry.getSlug()#")#" title="View Entry In Site" target="_blank"><img src="#prc.bbroot#/includes/images/eye.png" alt="edit" border="0"/></a>
				<!--- Edit Command --->
