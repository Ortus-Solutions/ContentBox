...
<div class="sidebar">
	...
	<div class="small_box">
		...
		<div class="body">
			...
			<div class="center">
				<button class="button2" onclick="window.open('#prc.bbHelper.linkPage( prc.page )#');return false;" title="Open page in site">Open In Site</button>
			</div>
			#html.endFieldset()#
			</cfif>
...
<div class="main_column">
	<div class="box">
		<!--- Body Header --->
		<div class="header">
			<img src="#prc.bbroot#/includes/images/blog.png" alt="editor" width="30" height="30" />
			Page Editor
		</div>
		<!--- Body --->
		<div class="body">
			...
			<label for="slug">Permalink: 
				<img src='#prc.bbroot#/includes/images/link.png' alt='permalink' title="Convert title to permalink" onclick="createPermalink()"/>
...
#html.addAsset(prc.bbroot&"/includes/js/blogbox.page.editor.js")#
