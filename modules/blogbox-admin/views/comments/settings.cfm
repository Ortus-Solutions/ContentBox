	...
	<div class="box">
		...
		<div class="body_vertical_nav clearfix">
			...
			<ul class="vertical_nav">
				...
				<li><a href="##moderation"><img src="#prc.bbRoot#/includes/images/lock.png" alt="modifiers"/> Moderation</a></li>
				<li><a href="##notifications"><img src="#prc.bbRoot#/includes/images/email.png" alt="modifiers"/> Notifications</a></li>
				<!--- bbadmin Event --->
				#announceInterception("bbadmin_onCommentSettingsNav")#
			</ul>		
			<!--- Documentation Panes --->	
			<div class="main_column">
				...
				<div class="panes_vertical">
					...
					<!--- bbadmin Event --->
					#announceInterception("bbadmin_onCommentSettingsContent")#
				</div>
				<!--- end panes_vertical --->
			</div>
			<!--- end main_column --->
