...
<div class="forgeBox-entrybox">
	...
	<!--- Info --->
	<h2>#prc.entries.title# v#prc.entries.version#</h2>
	...
	<div class="forgebox-download">
		<a href="javascript:installEntry('#JSStringFormat(prc.entries.downloadURL)#','#jsstringFormat(prc.entries.slug)#')" 
		   title="Install Entry"><img src="#prc.cbRoot#/includes/images/entry-link.png" alt="Download" border="0" /></a>
	</div>
	<!--- Info --->
	<p>
		<label class="inline">Author: </label> <a href="javascript:loadProfile('#jsStringFormat(prc.entries.username)#')">#prc.entries.username#</a> |
