	...
	<div class="span9" id="main-content">
		<div class="box">
			...
			<legend><i class="icon-cog icon-large"></i> <strong>Source Content</strong></legend>
				...
				#html.select(name="importer",options="Select Source,Mango,WordPress,BlogCFC,MachBlog", class="span4")#
				
				<!--- Default Password --->
				#html.label(field="tableprefix",content="Table Prefix:")#
				<small>The table prefix used by the source software.</small><br/>
				#html.textField(name="tableprefix",class="span4",size="30")#
				...
				#html.textField(name="defaultPassword",class="span4",size="30",required="required")#
				
				<!--- Roles --->
				#html.select(label="Default Author Role:",name="roleID",options=prc.roles,column="roleID",nameColumn="role", class="span4")#
			</fieldset>	
		...
		<div class="small_box">
			...
			<div class="body">
				...
				<div class="actionBar" id="uploadBar">
					#html.submitButton(value="Start Import",class="btn btn-danger btn-large", title="Start Import Process",onclick="return confirm('Really Start?')")#
				</div>
