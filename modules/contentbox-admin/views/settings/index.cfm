                ...
                <div class="panel-body">
                    ...
                    <div class="tab-wrapper tab-left tab-primary">
                        ...
                        <ul class="nav nav-tabs">
                            <li class="active">
                                <a href="##site_options" data-toggle="tab"><i class="fa fa-cog icon-large"></i> Site Options</a>
                            </li>
                            <li>
                            ...
                            <li>
                                <a href="##editor_options" data-toggle="tab"><i class="fa fa-edit icon-large"></i> Editor Options</a>
                            </li>
                            <li>
                                <a href="##mediamanager" data-toggle="tab"><i class="fa fa-th icon-large"></i> Media Manager</a>
                            </li>
                            <li>
                                <a href="##gravatars" data-toggle="tab"><i class="fa fa-user icon-large"></i> Gravatars</a>
                            </li>
                            <li>
                                <a href="##notifications" data-toggle="tab"><i class="fa fa-bullhorn icon-large"></i> Notifications</a>
                            </li>
                            <li>
                                <a href="##email_server" data-toggle="tab"><i class="fa fa-envelope icon-large"></i> Mail Server</a>
                            </li>
                            <li>
                                <a href="##search_options" data-toggle="tab"><i class="fa fa-search icon-large"></i> Search Options</a>
                            </li>
                            <li>
