...
#html.startForm( name="authorPreferencesForm", action=prc.xehAuthorPreferences, novalidate="novalidate", class="form-vertical")#
	...
	<!---Editor of Choice --->
	#html.select( name="preference.editor", 
	...
	<!---Markup of Choice --->
	#html.select( name="preference.markup", 
	...
	<!---Social Preferences --->
	#html.textfield( name="preference.twitter",
	...
	#html.textfield( name="preference.facebook",
	...
	#html.textfield( name="preference.google",
	...
	<!---Sidebar --->
	#html.select( name="preference.sidebarState",
				  label="Show Sidebar",
				  options="yes,no",
				  class="width98",
...
#html.startForm( name="authorRawPreferencesForm", action=prc.xehAuthorRawPreferences, novalidate="novalidate", class="form-vertical")#
	...
	<div id="rawPreferences" style="display:none">
		<!--- Raw Preferences --->
		#html.textarea( name="preferences",
