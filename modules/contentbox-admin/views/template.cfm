...
<div id="header_bg">
	...
	<div class="wrapper">
		...
		<div id="logo">
			<img src="#prc.cbRoot#/includes/images/ColdBoxLogoSquare_125.png" border="0" alt="logo" />
		</div>
        ...
        <div class="jump_menu">
            ...
            <ul class="jump_menu_list">
                <li><a href="##"><img src="#prc.cbRoot#/includes/images/users2_icon.png" alt="" width="24" height="24" />Users</a></li>
                <li><a href="##"><img src="#prc.cbRoot#/includes/images/tools_icon.png" alt="" width="24" height="24" />Settings</a></li>
                <li><a href="##"><img src="#prc.cbRoot#/includes/images/messages_icon.png" alt="" width="24" height="24" />Messages</a></li>
                <li><a href="##"><img src="#prc.cbRoot#/includes/images/key_icon.png" alt="" width="24" height="24" />Credentials</a></li>
                <li><a href="##"><img src="#prc.cbRoot#/includes/images/documents_icon.png" alt="" width="24" height="24" />Pages</a></li>
            </ul>
        </div>
		--->
		<!--End Jump Menu-->
...
<div class="content wrapper clearfix">
	...
	<div class="sidebar">
		...
		<div class="small_box">
			<div class="header">
				<img src="#prc.cbRoot#/includes/images/history_icon.png" alt="History" width="24" height="24" />History
			</div>
			<div class="body">
		...
		<div class="small_box">
			<div class="header">
				<img src="#prc.cbRoot#/includes/images/calendar_icon.png" alt="Calendar" width="24" height="24" />Calendar
			</div>
			<div class="body">
		...
		<div class="small_box">
			<div class="header">
				<img src="#prc.cbRoot#/includes/images/users_icon.png" alt="History" width="24" height="24" />Online Users
			</div>
			<div class="body">
				<ul class="user_list">
					<li><img src="#prc.cbRoot#/includes/images/user_placeholder.gif" width="54" height="54" alt="Username" /><a href="##">John Doe</a><small>Administrator</small></li>
					<li><img src="#prc.cbRoot#/includes/images/user_placeholder.gif" width="54" height="54" alt="Username" /><a href="##">John Doe</a><small>Administrator</small></li>
				</ul>
			</div>
		</div>
		...
		<div class="small_box clearfix">
			<div class="header">
				<img src="#prc.cbRoot#/includes/images/accordion_icon.png" alt="Accordion" width="24" height="24" />Accordion
			</div>
			<div class="body">
				<!--=== Accordion ===-->
				<div id="accordion" class="clearfix">
					<!-- Accordion 1 -->
					<h2 class="current"> <img src="#prc.cbRoot#/includes/images/arrow_right.png" alt="" width="6" height="6" class="arrow_right" /> <img src="#prc.cbRoot#/includes/images/arrow_down.png" alt="" width="6" height="6" class="arrow_down" /> First pane </h2>
					<div class="pane">
					...
					<!-- Accordion 2-->
					<h2> <img src="#prc.cbRoot#/includes/images/arrow_right.png" alt="" width="6" height="6" class="arrow_right" /> <img src="#prc.cbRoot#/includes/images/arrow_down.png" alt="" width="6" height="6" class="arrow_down" /> Second pane </h2>
					<div class="pane">
						<ul>
							<li>Sub Menu Item</li>
							<li>Sub Menu Item</li>
					...
					<!-- Accordion 3 -->
					<h2> <img src="#prc.cbRoot#/includes/images/arrow_right.png" alt="" width="6" height="6" class="arrow_right" /> <img src="#prc.cbRoot#/includes/images/arrow_down.png" alt="" width="6" height="6" class="arrow_down" /> Third pane </h2>
					<div class="pane">
						<ul>
							<li>Sub Menu Item</li>
							<li>Sub Menu Item</li>
	...
	<div class="main_column">
		...
		<div class="box">
			<div class="header">
				...
				<!--End sub navigation-->
				<img src="#prc.cbRoot#/includes/images/tables_icon.png" alt="Accordion" width="30" height="30" />Tables
			</div>
			<div class="body">
				<div class="panes">
	...
	<div class="box clear">
		<div class="header">
			<img src="#prc.cbRoot#/includes/images/tables_icon.png" alt="Accordion" width="30" height="30" />Forms &amp; Typography
		</div>
	...
	<div class="box column-left">
		<!--Begin Box-->
		<div class="header">
			<p><img src="#prc.cbRoot#/includes/images/half_width_icon.png" alt="Half Width Box" width="30" height="30" />Half Width</p>
		</div>
		<div class="body">
			Lorem ipsum dolor sit amet, <a href="##">consectetur</a> adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo <a href="##">consequat</a>. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.
		</div>
