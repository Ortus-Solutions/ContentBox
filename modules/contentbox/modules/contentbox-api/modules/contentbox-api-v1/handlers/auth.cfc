...
component extends="baseHandler" {
	 ...
	 *
	 * @tags        Authentication
	 * @requestBody contentbox/apidocs/auth/logout/requestBody.json
	 ...
	 *
	 * @tags        Authentication
	 * @requestBody contentbox/apidocs/auth/refreshToken/requestBody.json
	 ...
	 *
	 * @tags        Authentication
	 * @requestBody contentbox/apidocs/echo/whoami/requestBody.json
