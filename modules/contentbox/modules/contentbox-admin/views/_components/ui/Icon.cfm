        ...
        <svg fill="none" stroke="currentColor" stroke-width="1.75" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">      
            <cfswitch expression=#args.name#>
                ...
                <cfcase value="TowerBroadcast">
                    <path class="cls-1" d="m15.32,2.84c2.01,1.94,2.07,5.14.13,7.16m3.49-8.84c2.94,2.84,3.02,7.52.19,10.46m-12.57-1.62c-1.94-2.01-1.88-5.22.13-7.16m-3.81,8.78C.04,8.68.12,4,3.06,1.16m7.93,5.59v14.25m0-15.74c-.66,0-1.19.53-1.19,1.19s.53,1.19,1.19,1.19,1.19-.53,1.19-1.19-.53-1.19-1.19-1.19Z"/>
                </cfcase>
                <cfcase value="User">
