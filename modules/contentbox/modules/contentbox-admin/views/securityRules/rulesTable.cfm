				...
				<div class="btn-group btn-group-sm">
			    	...
			    	<ul class="dropdown-menu text-left pull-right">
						<cfif prc.oCurrentAuthor.checkPermission( "SECURITYRULES_ADMIN" )>
							...
							<!--- Export --->
							<li><a href="#event.buildLink(to=prc.xehExport)#/ruleID/#rule.getRuleID()#.json" target="_blank"><i class="fa fa-download"></i> Export as JSON</a></li>
							<li><a href="#event.buildLink(to=prc.xehExport)#/ruleID/#rule.getRuleID()#.xml" target="_blank"><i class="fa fa-download"></i> Export as XML</a></li>
						</cfif>
			    	</ul>
			    </div>
			</td>
