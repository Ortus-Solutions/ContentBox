		...
		<div class="modal-body">
			...
			#html.startForm( name="permissionRemoveForm" )#
				#html.startFieldset( legend="Active Role Permissions" )#
					...
					<div>
						<!--- Remove --->
						<a href="javascript:removePermission('#perm.getPermissionID()#')" onclick="return confirm('Are you sure?')" title="Remove Permission"><i class="fa fa-minus-circle fa-lg textRed"></i></a>
						<!--- Name --->
						&nbsp; 
