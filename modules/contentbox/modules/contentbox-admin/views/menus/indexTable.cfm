                    ...
                    <div class="btn-group btn-group-sm">
                        ...
                        <ul class="dropdown-menu text-left pull-right">
                            <cfif prc.oCurrentAuthor.checkPermission( "MENUS_ADMIN" )>
                                <!--- Delete Command --->
                                <li>
                                    <a title="Delete Menu" href="javascript:remove('#menu.getmenuID()#', 'menuID')" class="confirmIt" data-title="Delete Menu?"><i class="fa fa-trash-alt fa-lg" id="delete_#menu.getMenuID()#"></i> Delete</a>
                                </li>
                                <!--- Edit Command --->
                                <li>
