                                    ...
                                    <div class="btn-group">
                                        ...
                                        <ul class="dropdown-menu">
                                            ...
                                            <cfif prc.oCurrentAuthor.checkPermission( "MENUS_ADMIN,TOOLS_EXPORT" )>
												<li><a href="#event.buildLink (to=prc.xehMenuExportAll )#.json" target="_blank"><i class="fas fa-file-export fa-lg"></i> Export All as JSON</a></li>
												<li><a href="#event.buildLink( to=prc.xehMenuExportAll )#.xml" target="_blank"><i class="fas fa-file-export fa-lg"></i> Export All as XML</a></li>
											</cfif>
