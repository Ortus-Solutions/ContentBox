...
component extends="baseHandler"{
	...
	function save(event,rc,prc){
		...
		var isSaveableCategory = ( rc.categoryID!="" && ( ( ( isNull(categoryService.findWhere( criteria={ slug=rc.category } ) ) ) || ( categoryService.findWhere( criteria={ slug=rc.category } ).getcategoryID() == rc.categoryID ) ) || isNull( categoryService.findWhere( criteria={ slug=rc.category } ) ) ) ) || isNull( categoryService.findWhere( criteria={ slug=rc.category } ) ) ? true : false;
		// if non-existent
