...
component persistent="true" entityname="cbSubscription" table="cb_subscriptions" cachename="cbSubscription" cacheuse="read-write" {
    ...
    property name="subscriber" notnull="true" cfc="contentbox.model.subscriptions.Subscriber" fieldtype="many-to-one" fkcolumn="FK_subscriberID" lazy="true" index="idx_subscriber" inverse="true" orderBy="subscriberEmail";
    /************************************** CONSTRUCTOR *********************************************/
