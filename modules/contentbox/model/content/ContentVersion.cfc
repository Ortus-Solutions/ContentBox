...
component persistent="true" entityname="cbContentVersion" table="cb_contentVersion" batchsize="25" cachename="cbContentVersion" cacheuse="read-write"{
	...
	property name="version"			notnull="false" ormtype="integer"	default="1" dbdefalt="1" index="idx_version";
	...
	// M20 -> relatedContent
	property name="relatedContent" cfc="contentbox.model.content.BaseContent" fieldtype="many-to-one" fkcolumn="FK_contentID" lazy="true" fetch="join" index="idx_contentVersions";
