...
component persistent="true" entityname="cbCategory" table="cb_category"{
	...
	// M2M -> Entry
	property name="entries" cfc="contentbox.model.content.Entry" fieldtype="many-to-many" type="array" lazy="true"
		linktable="cb_entryCategories" fkcolumn="FK_categoryID" inversejoincolumn="FK_entryID";
