...
component implements="contentbox.model.importers.ICBImporter" {
	...
	*/
	function execute(required dsn,dsnUsername="",dsnPassword="",defaultPassword="",required roleID,tableprefix=""){
		...
		//writeDump(expandPath("/modules/contentbox/content")); abort;
...
<img
	align="left"
	alt="NoFacebookAppDirectory"
	border="0"
	height="185"
	src="http://www.andyscott.id.au/enclosures/NoFacebookAppDirectory_thumb.jpg"
	style="background-image: none; border-right-width: 0px; margin: 9px 12px 5px 0px; padding-left: 0px; padding-right: 0px; display: inline; float: left; border-top-width: 0px; border-bottom-width: 0px; border-left-width: 0px; padding-top: 0px"
	title="NoFacebookAppDirectory"
	width="244" />
