...
<div id="comment_#comment.getCommentID()#" class="comment">
	...
	<h4>
		<cfif len(comment.getAuthorURL())>
			<a href="<cfif NOT findnocase( "http",comment.getAuthorURL())>http://</cfif>#comment.getAuthorURL()#" title="Open #comment.getAuthorURL()#"><img src="#cb.themeRoot()#/includes/images/link.png" alt="url" border="0" /></a>
		</cfif>
