...
# Database: contentbox
# Generation Time: 2011-10-27 14:50:12 +0000
# ************************************************************
...
INSERT INTO `cb_author` (`authorID`, `firstName`, `lastName`, `email`, `username`, `password`, `isActive`, `lastLogin`, `createdDate`)
VALUES
	(1,'Luis','Majano','lmajano@gmail.com','lmajano','EE60C08DE56FCDAC31D7A0D8F2C8ED1D550A3670DCF577F43F0A44AB7523ECE6',b'1','2011-10-27 16:28:10','2011-07-08 00:00:00'),
	(7,'ContentBox','Administrator','youremail@email.com','contentbox','27BB116667D70801E61FDCE8CF1E556963BDF711A5B72AEF954E6575C17F0A70',b'1',NULL,'2011-07-30 10:48:37');
...
CREATE TABLE `cb_comment` (
  ...
  CONSTRAINT `FKB85616066ED93A5` FOREIGN KEY (`FK_entryID`) REFERENCES `cb_entry` (`entryID`),
  CONSTRAINT `FKB856160913DC393` FOREIGN KEY (`FK_pageID`) REFERENCES `cb_page` (`pageID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

LOCK TABLES `cb_comment` WRITE;
/*!40000 ALTER TABLE `cb_comment` DISABLE KEYS */;

INSERT INTO `cb_comment` (`commentID`, `content`, `author`, `authorIP`, `authorEmail`, `authorURL`, `createdDate`, `isApproved`, `FK_entryID`, `FK_pageID`)
VALUES
	(27,'asdfsdf','Luis Majano','127.0.0.1','lmajano@gmail.com','www.luismajano.com','2011-08-19 15:00:40',b'1',9,NULL),
	(28,'asdfasdf','Luis Majano','127.0.0.1','blogbox@ortussolutions.com','www.luismajanco.com','2011-08-19 15:00:56',b'1',NULL,3);
...
CREATE TABLE `cb_entryCategories` (
  ...
  CONSTRAINT `FKFB8AA62F1AC77BB1` FOREIGN KEY (`FK_categoryID`) REFERENCES `cb_category` (`categoryID`),
  CONSTRAINT `FKFB8AA62F66ED93A5` FOREIGN KEY (`FK_entryID`) REFERENCES `cb_entry` (`entryID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

LOCK TABLES `cb_entryCategories` WRITE;
/*!40000 ALTER TABLE `cb_entryCategories` DISABLE KEYS */;

INSERT INTO `cb_entryCategories` (`FK_categoryID`, `FK_entryID`)
VALUES
	(9,5),
	(7,5),
	(7,7),
...
/*!40000 ALTER TABLE `cb_entryCategories` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `cb_page` (
  ...
  CONSTRAINT `FKECCCB72E4289940B` FOREIGN KEY (`FK_authorID`) REFERENCES `cb_author` (`authorID`),
  CONSTRAINT `FKECCCB72E6608086E` FOREIGN KEY (`FK_parentID`) REFERENCES `cb_page` (`pageID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

LOCK TABLES `cb_page` WRITE;
/*!40000 ALTER TABLE `cb_page` DISABLE KEYS */;

INSERT INTO `cb_page` (`pageID`, `hits`, `HTMLKeywords`, `publishedDate`, `createdDate`, `slug`, `passwordProtection`, `allowComments`, `content`, `HTMLDescription`, `layout`, `title`, `isPublished`, `FK_authorID`, `FK_parentID`, `order`)
VALUES
	(2,62,'','2011-08-10 17:25:00','2011-08-10 17:25:28','about-us','',b'0','<p>\r\n	Welcome to your BlogBox installation. Enjoy it!</p>\r\n','','pages','About Us',b'1',1,NULL,0),
	(3,118,'','2011-08-16 18:28:00','2011-08-16 18:28:56','projects','',b'1','<p>\r\n	Where al my cool projects are</p>\r\n','','pages','Projects',b'1',1,NULL,2),
	(4,14,'','2011-08-16 18:37:00','2011-08-16 18:37:15','contact-us','',b'1','<p>\r\n	This is my contact us page</p>\r\n','','pages','Contact Us',b'1',1,NULL,1),
	(5,25,'','2011-08-16 18:41:00','2011-08-16 18:42:08','project-1','',b'1','<p>\r\n	This is project 1</p>\r\n','','pages','Project 1',b'1',1,3,0),
	(6,108,'','2011-08-16 20:41:00','2011-08-16 20:41:26','project-2','',b'0','<p>\r\n	Project 2 Project 2 Project 2</p>\r\n','','pageNoSidebar','Project 2',b'1',1,3,1);
...
VALUES
	(3,'cb_site_name','ContentBox by ColdBox'),
	(4,'cb_site_email','myemail@email.com'),
	(5,'cb_site_tagline','An Awesome Content Platform'),
	(6,'cb_paging_maxrows','20'),
	(7,'cb_paging_bandgap','5'),
	(8,'cb_gravatar_display','true'),
	(9,'cb_gravatar_rating','PG'),
	(11,'cb_comments_whoisURL','http://whois.arin.net/ui/query.do?q'),
	(12,'cb_comments_maxDisplayChars','500'),
	(13,'cb_dashboard_recentEntries','5'),
	(14,'cb_dashboard_recentComments','5'),
	(15,'cb_comments_enabled','true'),
	(16,'cb_comments_urltranslations','true'),
	(17,'cb_comments_moderation','true'),
	(18,'cb_comments_moderation_whitelist','true'),
	(19,'cb_comments_notify','true'),
	(20,'cb_comments_moderation_notify','true'),
	(21,'cb_comments_notifyemails',''),
	(22,'cb_site_description','Welcome to the most awesomest content platform on planet earth!  Please feel free to poke around and learn about ContentBox by ColdBox!'),
	(23,'cb_comments_moderation_blacklist',''),
	(24,'cb_comments_moderation_blockedlist',''),
	(25,'cb_site_keywords','ContentBox,ColdBox Platform,Blogging Platform, Content Platform,CMS,enterprise CMS,Blog,Enterprise Blog,ColdFusion Blog,coldfusion CMS,adobe,railo,flex,air,RESTful blog, RESTful CMS'),
	(26,'cb_notify_author','false'),
	(27,'cb_paging_maxentries','10'),
	(29,'cb_notify_entry','true'),
	(30,'cb_site_outgoingEmail','myemail@email.com'),
	(37,'cb_site_layout','default'),
	(38,'cb_comments_captcha','true'),
	(39,'cb_paging_maxRSSComments','10'),
	(40,'cb_rss_cachingTimeout','60'),
	(41,'cb_rss_maxEntries','10'),
	(42,'cb_rss_caching','false'),
	(43,'cb_rss_maxComments','10'),
