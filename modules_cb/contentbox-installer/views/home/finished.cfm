...
<div class="panel panel-primary">
    <div class="panel-heading">
        <h3 class="panel-title"><i class="fa fa-lightbulb-o"></i> #cb.r( "finished.title@installer" )#</h3>
    </div>
    <div class="panel-body">
        <div class="jumbotron">
			...
			<div class="alert alert-danger">
				...
				<em>/{installed_location}/modules_cb/contentbox-installer</em><br/>
				<em>/{installed_location}/modules_cb/contentbox-dsncreator</em></strong>
			</div>
			<hr>
