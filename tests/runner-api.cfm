...
<cfparam name="url.directory" 		default="tests.specs.contentbox-api">
...
<!---<cfparam name="url.coverageSonarQubeXMLOutputPatha"	default="#expandPath( '/tests/results/SonarQubeCoverage.xml' )#">--->
