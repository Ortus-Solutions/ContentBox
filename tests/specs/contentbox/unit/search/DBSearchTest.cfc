...
********************************************************************************
*/
component extends="coldbox.system.testing.BaseModelTest" model="contentbox.models.search.DBSearch"{

	function setup(){
		super.setup();
		model.init();
		mockContentService = getMockBox().createEmptyMock("contentbox.models.content.ContentService");
	...
	function testSearch(){
		mockResults = getMockBox().createMock("contentbox.models.search.SearchResults").init();
	...
	function testRenderSearchWithResults(){
		...
		mockResults = getMockBox().createMock("contentbox.models.search.SearchResults").init().populate( results );
