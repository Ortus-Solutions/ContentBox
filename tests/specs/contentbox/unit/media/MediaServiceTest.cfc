...
component extends="coldbox.system.testing.BaseModelTest" model="contentbox.models.media.MediaService"{
	...
	function setup(){
		...
		mockSettings = getMockBox().createEmptyMock("contentbox.models.system.SettingService").$("getSetting","CFContentMediaProvider");
	...
	function testGetCoreMediaRoot() {
		mockSettings = getMockBox().createEmptyMock("contentbox.models.system.SettingService").$("getSetting","/content");
		model.$property("settingService","variables",mockSettings);
