...
CREATE TABLE `cb_author` (
  ...
  `isPasswordReset` bit(1) NOT NULL DEFAULT 0,
  `is2FactorAuth` bit(1) NOT NULL DEFAULT 0,
...
VALUES
	(1,'Luis','Majano','lmajano@gmail.com','lmajano','$2a$12$KU4n4ZQf3cd/ULCuvc8PIO9VrQKi7eKbcEuQaILTJ/sdcjXvT31YK',1,'2021-02-18 17:54:10','2013-07-11 11:06:39','','{\"sidemenuCollapse\":\"yes\",\"linkedin\":\"\",\"sidebarState\":\"yes\",\"markup\":\"HTML\",\"website\":\"\",\"editor\":\"ckeditor\",\"twitter\":\"http://twitter.com/lmajano\",\"facebook\":\"http://facebook.com/lmajano\"}',2,'2021-02-18 17:54:10',0,0,0),
...
VALUES
	(11,'Test','Luis','','lmajano@gmail.com','','2015-08-04 16:17:43',0,142,'2021-02-18 17:58:20',0),
...
CREATE TABLE `cb_content` (
  ...
  `title` varchar(200) NOT NULL, `slug` varchar(200) NOT NULL,
  `createdDate` datetime NOT NULL,
  `publishedDate` datetime DEFAULT NULL,
  `expireDate` datetime DEFAULT NULL,
  `isPublished` bit(1) NOT NULL DEFAULT 1,
  `allowComments` bit(1) NOT NULL DEFAULT 1,
  `passwordProtection` varchar(100) DEFAULT NULL,
  `HTMLKeywords` varchar(160) DEFAULT NULL,
  `HTMLDescription` varchar(160) DEFAULT NULL,
  `cache` bit(1) NOT NULL DEFAULT 1,
  `cacheLayout` bit(1) NOT NULL DEFAULT 1,
  ...
  `showInSearch` bit(1) NOT NULL DEFAULT 1,
...
VALUES
	...
	(110,'Entry','Couchbase Details','couchbase-details','2013-07-26 16:55:00','2013-10-11 10:31:00',NULL,1,1,'','','',1,1,0,0,'HTML',1,NULL,1,'','','2021-02-19 10:54:25',0,'',1),
...
VALUES
	...
	(267,'<p>{{{ContentStore slug=\'contentbox\'}}}</p>\r\n\r\n<p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Ut odio. Nam sed est. Nam a risus et est iaculis adipiscing. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Integer ut justo. In tincidunt viverra nisl. Donec dictum malesuada magna. Curabitur id nibh auctor tellus adipiscing pharetra. Fusce vel justo non orci semper feugiat. Cras eu leo at purus ultrices tristique.</p>\r\n\r\n<p>Duis autem vel eum iriure dolor in hendrerit in vulputate velit esse molestie consequat, vel illum dolore eu feugiat nulla facilisis at vero eros et accumsan et iusto odio dignissim qui blandit praesent luptatum zzril delenit augue duis dolore te feugait nulla facilisi. Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna aliquam erat volutpat.</p>\r\n\r\n<p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Ut odio. Nam sed est. Nam a risus et est iaculis adipiscing. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Integer ut justo. In tincidunt viverra nisl. Donec dictum malesuada magna. Curabitur id nibh auctor tellus adipiscing pharetra. Fusce vel justo non orci semper feugiat. Cras eu leo at purus ultrices tristique.</p>\r\n\r\n<p>Duis autem vel eum iriure dolor in hendrerit in vulputate velit esse molestie consequat, vel illum dolore eu feugiat nulla facilisis at vero eros et accumsan et iusto odio dignissim qui blandit praesent luptatum zzril delenit augue duis dolore te feugait nulla facilisi. Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna aliquam erat volutpat.</p>\r\n\r\n<p>&nbsp;</p>\r\n','quick save',2,'2013-08-29 08:32:16',0,1,110,'2021-02-19 10:54:25',0),
	...
	(454,'<p># Test App This is my `cool` documentation {{{ContentStore slug=\'firefox-test\'}}} I want an image: ![ContentBoxIcon300.png](/index.cfm/__media/ContentBoxIcon300.png) This is an amazing coding styles</p>\r\n\r\n<pre class=\"brush: coldfusion\">\r\nCode Fences Work</pre>\r\n','',6,'2016-05-06 15:47:42',0,1,192,'2016-05-06 16:12:27',0),
	(455,'<p># Test App This is my `cool` documentation {{{ContentStore slug=\'firefox-test\'}}} I want an image: ![ContentBoxIcon300.png](/index.cfm/__media/ContentBoxIcon300.png) This is an amazing coding styles</p>\r\n\r\n<pre class=\"brush: coldfusion\">\r\nCode Fences Work\r\n</pre>\r\n','quick save',7,'2016-05-06 16:12:27',0,1,192,'2016-05-06 16:16:02',0),
	(456,'<p># Test App This is my `cool` documentation {{{ContentStore slug=\'firefox-test\'}}} I want an image: ![ContentBoxIcon300.png](/index.cfm/__media/ContentBoxIcon300.png) This is an amazing coding styles</p>\r\n\r\n<pre class=\"brush: coldfusion\">\r\nCode Fences Work\r\n</pre>\r\n\r\n\r\n','quick save',8,'2016-05-06 16:16:02',0,1,192,'2016-05-09 15:18:20',0),
	(457,'<p># Test App This is my `cool` documentation {{{ContentStore slug=\'firefox-test\'}}} I want an image: ![ContentBoxIcon300.png](/index.cfm/__media/ContentBoxIcon300.png) This is an amazing coding styles</p>\r\n\r\n<pre class=\"brush: coldfusion\">\r\nCode Fences Work\r\n</pre>\r\n\r\n\r\n','quick save',9,'2016-05-09 15:18:20',0,1,192,'2016-05-10 14:31:20',0),
	(458,'<p># Test App This is my `cool` documentation {{{ContentStore slug=\'firefox-test\'}}} I want an image: ![ContentBoxIcon300.png](/index.cfm/__media/ContentBoxIcon300.png) This is an amazing coding styles</p>\r\n\r\n<pre class=\"brush: coldfusion\">\r\nCode Fences Work\r\n</pre>\r\n\r\n\r\n','quick save',10,'2016-05-10 14:31:20',0,1,192,'2016-05-11 15:52:40',0),
	(459,'<p># Test App This is my `cool` documentation {{{ContentStore slug=\'firefox-test\'}}} I want an image: ![ContentBoxIcon300.png](/index.cfm/__media/ContentBoxIcon300.png) This is an amazing coding styles</p>\r\n\r\n<pre class=\"brush: coldfusion\">\r\nCode Fences Work\r\n</pre>\r\n\r\n\r\n','quick save',11,'2016-05-11 15:52:40',0,1,192,'2016-05-11 15:52:45',0),
	(460,'<p># Test App This is my `cool` documentation {{{ContentStore slug=\'firefox-test\'}}} I want an image: ![ContentBoxIcon300.png](/index.cfm/__media/ContentBoxIcon300.png) This is an amazing coding styles</p>\r\n\r\n<pre class=\"brush: coldfusion\">\r\nCode Fences Work\r\n</pre>\r\n\r\n\r\n','quick save',12,'2016-05-11 15:52:45',0,1,192,'2016-05-18 11:42:34',0),
	...
	(495,'<p># Test App This is my `cool` documentation {{{ContentStore slug=\'firefox-test\'}}} I want an image: ![ContentBoxIcon300.png](/index.cfm/__media/ContentBoxIcon300.png) This is an amazing coding styles</p>\r\n\r\n<pre class=\"brush: coldfusion\">\r\nCode Fences Work\r\n</pre>\r\n\r\n\r\n','',13,'2016-05-18 11:42:34',0,1,192,'2016-05-18 11:45:50',0),
	(496,'<p># Test App This is my `cool` documentation {{{ContentStore slug=\'firefox-test\'}}} I want an image: ![ContentBoxIcon300.png](/index.cfm/__media/ContentBoxIcon300.png) This is an amazing coding styles</p>\r\n\r\n<pre class=\"brush: coldfusion\">\r\nCode Fences Work\r\n</pre>\r\n\r\n\r\n','',14,'2016-05-18 11:45:50',0,1,192,'2016-06-14 13:46:47',0),
	...
	(499,'<p>{{{ContentStore slug=\'support-options-baby\'}}}</p>\r\n\r\n<p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Ut odio. Nam sed est. Nam a risus et est iaculis adipiscing. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Integer ut justo. In tincidunt viverra nisl. Donec dictum malesuada magna. Curabitur id nibh auctor tellus adipiscing pharetra. Fusce vel justo non orci semper feugiat. Cras eu leo at purus ultrices tristique.</p>\r\n\r\n<p>Duis autem vel eum iriure dolor in hendrerit in vulputate velit esse molestie consequat, vel illum dolore eu feugiat nulla facilisis at vero eros et accumsan et iusto odio dignissim qui blandit praesent luptatum zzril delenit augue duis dolore te feugait nulla facilisi. Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna aliquam erat volutpat.</p>\r\n\r\n<p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Ut odio. Nam sed est. Nam a risus et est iaculis adipiscing. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Integer ut justo. In tincidunt viverra nisl. Donec dictum malesuada magna. Curabitur id nibh auctor tellus adipiscing pharetra. Fusce vel justo non orci semper feugiat. Cras eu leo at purus ultrices tristique.</p>\r\n\r\n<p>Duis autem vel eum iriure dolor in hendrerit in vulputate velit esse molestie consequat, vel illum dolore eu feugiat nulla facilisis at vero eros et accumsan et iusto odio dignissim qui blandit praesent luptatum zzril delenit augue duis dolore te feugait nulla facilisi. Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna aliquam erat volutpat.</p>\r\n\r\n<p>&nbsp;</p>\r\n','',3,'2021-02-19 10:54:25',1,1,110,'2021-02-19 10:54:25',0);
...
CREATE TABLE `cb_page` (
  ...
  `order` int(11) DEFAULT '0',
  `showInMenu` bit(1) NOT NULL DEFAULT 1,
  `excerpt` longtext,
  `SSLOnly` bit(1) NOT NULL DEFAULT 0,
  PRIMARY KEY (`contentID`),
...
CREATE TABLE `cb_securityRule` (
  ...
  `useSSL` bit(1) NOT NULL DEFAULT 0,
...
CREATE TABLE `cb_setting` (
  ...
  `value` longtext NOT NULL,
  `isCore` bit(1) NOT NULL DEFAULT 0,
  `createdDate` datetime NOT NULL,
  `modifiedDate` datetime NOT NULL,
  `isDeleted` bit(1) NOT NULL DEFAULT 0,
  `FK_siteId` int(10) unsigned DEFAULT NULL,
...
CREATE TABLE `cb_site` (
  ...
  `isBlogEnabled` bit(1) NOT NULL DEFAULT 1,
  `isSitemapEnabled` bit(1) NOT NULL DEFAULT 1,
  `poweredByHeader` bit(1) NOT NULL DEFAULT 1,
  `adminBar` bit(1) NOT NULL DEFAULT 1,
  `isSSL` bit(1) NOT NULL DEFAULT 0,
  `activeTheme` varchar(255) DEFAULT NULL,
  `notificationEmails` text,
  `notifyOnEntries` bit(1) NOT NULL DEFAULT 1,
  `notifyOnPages` bit(1) NOT NULL DEFAULT 1,
  `notifyOnContentStore` bit(1) NOT NULL DEFAULT 1,
...
VALUES
	(1,'2020-09-09 17:16:59','2021-02-18 18:15:53',0,'Default Site','default','My Awesome Site','127\\.0\\.0\\.1','','My Awesome Site','support',1,1,1,1,0,'default','lmajano@gmail.com',1,1,1,'127.0.0.1'),
...
VALUES
	(31,10,190,'2016-05-03 16:23:26','2021-02-19 10:51:56',0),
	(32,3,191,'2016-05-03 16:23:26','2021-02-19 10:51:59',0),
	(33,5,189,'2016-05-03 16:23:26','2021-02-19 10:52:00',0),
	(35,129,147,'2016-05-03 16:23:26','2021-02-19 10:54:50',0),
	(38,4,162,'2016-05-03 16:23:26','2021-02-19 10:52:03',0),
	(39,1,160,'2016-05-03 16:23:26','2016-05-03 16:23:26',0),
	(43,4,207,'2016-05-18 11:35:32','2021-02-19 10:51:51',0),
	(44,5,213,'2016-05-18 11:35:32','2021-02-19 10:51:43',0),
	(45,1,192,'2016-05-18 11:48:04','2016-05-18 11:48:04',0),
	(46,10,141,'2016-08-05 11:41:28','2021-02-19 10:53:28',0),
	(47,29,142,'2016-11-28 14:56:53','2017-06-20 11:37:12',0),
	(48,1,135,'2021-02-19 10:53:24','2021-02-19 10:53:24',0),
	(49,1,110,'2021-02-19 10:53:35','2021-02-19 10:53:35',0);
